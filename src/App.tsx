...
import AcademicTeaching from "./pages/AcademicTeaching";
...
const App = () => (
  <QueryClientProvider client={queryClient}>
    <TooltipProvider>
      <Toaster />
      <Sonner />
      <BrowserRouter basename="/sunny-outlook-portfolio">
        <ScrollToTop />
        <Routes>
          ...
          <Route path="/projects/academic-teaching" element={<AcademicTeaching />} />
